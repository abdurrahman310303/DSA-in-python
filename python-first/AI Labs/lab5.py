...
class Lab5:
    ...
    def __init__(self) :
        ...
        self.greeting = "This is lab Five"
...
numOfWords = lab5.readFile(filename)
...
print("The sum of all Evens : " + str(lab5.sumOfAllEven(listOfInts)))

#Task Three
listOfStrings = ["abc","def","ghi","jkl"]
print("The List in Uppercase : "+str(lab5.convertToUpperCase(listOfStrings)))
...
sorted_by_age = lab5.sort_dict_list(dict_list, 'age')
print("Sorted by age:")
print(sorted_by_age)

sorted_by_name = lab5.sort_dict_list(dict_list, 'name')
print("\nSorted by name:")
print(sorted_by_name)

sorted_by_city = lab5.sort_dict_list(dict_list, 'city')
print("\nSorted by city:")
print(sorted_by_city)

#Task Five
listOfStrings1 = ["abc","fed","bad","jkl","abc"]
print("The List of Common Elements : "+str(lab5.commonElements(listOfStrings,listOfStrings1)))
...
print("\n")
filtered_dict = lab5.checkIntValues(checkIntValuesDict)
print(filtered_dict)
...
new_dict = lab5.checkStringInDict(checkwordDistionary,"New York")
...
merged_dict = lab5.mergeTwoDict(dict1, dict2)
print(merged_dict)

#Task Nine
print("The reverse of the string is : "+str(lab5.reverseString("Abdur Rahman")))
